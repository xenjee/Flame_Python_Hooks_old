...
def getCustomUIActions():
    ...
    utilitiesAction1 = {}
    utilitiesAction1["name"] = "exports_config"
    utilitiesAction1["caption"] = "Exports Config"

    utilitiesAction2 = {}
    utilitiesAction2["name"] = "Metadata"
    utilitiesAction2["caption"] = "Clip Metadata"

    utilitiesAction3 = {}
    utilitiesAction3["name"] = "pathcopy"
    utilitiesAction3["caption"] = "Copy Path"
    ...
    appsAction2 = {}
    appsAction2["name"] = "blender_Start apps"
    appsAction2["caption"] = "Blender"

    appsAction3 = {}
    appsAction3["name"] = "natron_Start apps"
    appsAction3["caption"] = "Natron"

    UtilitiesGroup = {}
    UtilitiesGroup["name"] = "Utilities"
    UtilitiesGroup["actions"] = (utilitiesAction1, utilitiesAction2, utilitiesAction3,)

    appsGroup = {}
    appsGroup["name"] = "Apps"
    appsGroup["actions"] = (appsAction1, appsAction2, appsAction3,)

    return (UtilitiesGroup, appsGroup,)
...
############
    ...
    if info['name'] == 'pathcopy':
        print '-' * 20 + "hook_lewis copy path" + '-' * 20
